...
def clip_boxes(boxes, shape):
    ...
    if isinstance(boxes, torch.Tensor):
        # Avoid in-place operations by creating a new tensor with the clipped values
        ...
        clipped_boxes = boxes.copy()  # Avoid modifying the original boxes
        clipped_boxes[..., [0, 2]] = boxes[..., [0, 2]].clip(0, shape[1])  # x1, x2
        clipped_boxes[..., [1, 3]] = boxes[..., [1, 3]].clip(0, shape[0])  # y1, y2
