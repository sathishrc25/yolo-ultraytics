...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # ONNX Runtime
            ...
            check_requirements(("onnx", "onnxruntime-gpu" if cuda else "onnxruntime-cann" if npu else "onnxruntime"))
            ...
            if cuda:
                ...
                providers = [("CANNExecutionProvider", {"device_id": device.index})]
            else:
